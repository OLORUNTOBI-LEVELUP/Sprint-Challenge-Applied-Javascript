class Carousel {
    ...
    rightClick() {  
      ...
      let newImage = document.querySelector(`.carousel img[data-index="${this.currentIndex}"]`)
      let previousImage = document.querySelector(`.carousel img[data-index="${this.currentIndex - 1}"]`)
